	...
	<div class="site-wrapper clearfix">
		...
		<div class="site-content">
			<div class="container d-flex">
					...
					<!-- Sidebar -->
					<div class="sidebar sidebar--shop col-md-3">
						...
						<aside class="widget card widget--sidebar widget_categories">
							...
							<div class="widget__content card__content">
								<ul class="widget__list">
									...
									<li class="has-children"><a href="#">AYAKKABILAR</a>
										<ul>
							...
							<form action="#" class="filter-price-form">
								...
								<div class="widget__content card__content">
									...
									<div class="slider-range-wrapper">
										<div id="slider-range" class="slider-range noUi-target noUi-ltr noUi-horizontal"></div>
...
_gaq.push(['_trackPageview']);
    ...
    <script type="text/javascript">//<![CDATA[
        ...
        //]]></script></head>
<body class="  catalog-category-view grid-fluid categorypath-men-html category-men">
...
<div class="wrapper">
    ...
    <div class="category-products product-columns-4">
    	<div class="toolbar">
				...
				<div class="sort-by">
					<div class="sort-by-wrap toolbar-switch icon-white">
						<div class="toolbar-title">
							<label class="sr">Sıralama</label>
							<span class="current">Pozisyon</span>
							<select onchange="setLocation(this.value)">
																	<option
										value="https://athlete.olegnax.com/index.php/men.html?___store=gr&amp;dir=asc&amp;mode=grid&amp;order=position" selected="selected">
										Pozisyon									</option>
																	<option
										value="https://athlete.olegnax.com/index.php/men.html?___store=gr&amp;dir=asc&amp;mode=grid&amp;order=name">
										Adı									</option>
																	<option
										value="https://athlete.olegnax.com/index.php/men.html?___store=gr&amp;dir=asc&amp;mode=grid&amp;order=price">
Fiyat															</select>
						</div>
						<div class="toolbar-dropdown">
							<ul><li class="selected"><a href="#">Pozisyon</a></li><li><a href="#">Adı</a></li><li><a href="#">Fiyat</a></li></ul>
						</div>
					</div>
											<a class="sort-by-arrow icon-white" href="#"
						   title="Set Descending Direction"><img class="i_asc_arrow v-middle" width="29" height="58"
								src="../4mynot4give/assets/images/i_asc_arrow.png"
								alt="Set Descending Direction"></a>
									</div>

													<p class="view-mode icon-white">
																			<label class="sr">İzle</label>
																								<strong title="Grid"
									        class="grid">Grid</strong>
																																<a href="#" title="List"
									   class="list">Listele</a>
																										</p>
				
				<div class="limiter toolbar-switch icon-white">
					<div class="toolbar-title">
						<label class="sr">Göster</label>
						...
						sayfadan					</div>
					<div class="toolbar-dropdown">
						<ul><li class="selected"><a href="#">12</a></li><li><a href="#">36</a></li><li><a href="#">100</a></li></ul>
					</div>
                    	...
                    	<div class="pager slim_pager">        
                        	<p class="amount">
                           	                                 Toplam 28 üründen 12'si gösteriliyor.                                                    	</p>        
        ...
        <ol>
                ...
                <a class="next i-next  icon-white" href="#" title="Next product">
                                            <img  width="29" height="58" src="../4mynot4give/assets/images/pager_arrow_right.png" alt="Next product" class="v-middle" />
                                    </a>
            </li>
                </ol>
			...
			<div class="item-wrap">
				<a href="#" title="Spor ayakkabı" class="product-image">
					<div class="sale-label label-bottom-left">SATILIK</div>					<img id="product-collection-image-18"  class="additional_img" src="../4mynot4give/assets/images/product/product-demo.jpg" data-srcX2="https://athlete.olegnax.com/media/catalog/product/cache/10/small_image/434x434/9df78eab33525d08d6e5fb8d27136e95/h/_/h_t1-hover.png" width="217" height="217" alt="Spor ayakkabı" />					<img class="regular_img" id="product-original-image-18" src="../4mynot4give/assets/images/product/product-demo-1.jpg"  width="217" height="217" alt="Spor ayakkabı" />				</a>
				<div class="product-hover">
										<h2 class="product-name"><a href="#" title="Spor ayakkabı">Spor ayakkabı</a></h2><br/>
    ...
    <div class="price-box">
        ...
        <span class="price" id="product-minimal-price-18">
			...
			<div class="item-wrap">
				<a href="#" title="Spor ayakkabı" class="product-image">
										<img id="product-collection-image-107"  class="additional_img" src="../4mynot4give/assets/images/product/product-demo.jpg"  width="217" height="217" alt="Spor ayakkabı" />					<img class="regular_img" id="product-original-image-107" src="../4mynot4give/assets/images/product/product-demo-1.jpg"  width="217" height="217" alt="Spor ayakkabı" />				</a>
				<div class="product-hover">
										<h2 class="product-name"><a href="#" title="Spor ayakkabı">Spor ayakkabı</a></h2><br/>
    ...
    <div class="price-box">
        ...
        <a href="javascript:void(0)" name="yellow-purple" class="swatch-link swatch-link-134 has-image" title="yellow-purple"
               style="height: 32px; width: 32px;">
            <span class="swatch-label" style="height: 30px; width: 30px; line-height: 30px;">
                            <img src="../4mynot4give/assets/images/product/product-demo-1.jpg" alt="yellow-purple" width="30" height="30" />
                         </span>
        </a>
    </li>
	
                <li class="option-purple-blue" data-product-id="107" data-option-label="purple-blue">
        <a href="javascript:void(0)" name="purple-blue" class="swatch-link swatch-link-134 has-image" title="purple-blue"
               style="height: 32px; width: 32px;">
            <span class="swatch-label" style="height: 30px; width: 30px; line-height: 30px;">
                            <img src="../4mynot4give/assets/images/product/product-demo.jpg" alt="purple-blue" width="30" height="30" />
                         </span>
        </a>
    </li>
                <li class="option-green-yellow" data-product-id="107" data-option-label="green-yellow">
        <a href="javascript:void(0)" name="green-yellow" class="swatch-link swatch-link-134 has-image" title="green-yellow"
               style="height: 32px; width: 32px;">
            <span class="swatch-label" style="height: 30px; width: 30px; line-height: 30px;">
                            <img src="../4mynot4give/assets/images/product/product-demo.jpg" alt="green-yellow" width="30" height="30" />
                         </span>
        </a>
    </li>
                <li class="option-blue-green" data-product-id="107" data-option-label="blue-green">
        <a href="javascript:void(0)" name="blue-green" class="swatch-link swatch-link-134 has-image" title="blue-green"
               style="height: 32px; width: 32px;">
            <span class="swatch-label" style="height: 30px; width: 30px; line-height: 30px;">
                            <img src="../4mynot4give/assets/images/product/product-demo.jpg" alt="blue-green" width="30" height="30" />
                         </span>
        </a>
    </li>
    </ul>
			...
			<div class="item-wrap">
				<a href="#" title="Spor ayakkabı" class="product-image">
					<div class="sale-label label-bottom-left">SATILIK</div>					<img id="product-collection-image-11"  class="additional_img" src="../4mynot4give/assets/images/product/product-demo.jpg"  width="217" height="217" alt="Spor ayakkabı" />					<img class="regular_img" id="product-original-image-11" src="../4mynot4give/assets/images/product/product-demo-1.jpg"  width="217" height="217" alt="Spor ayakkabı" />				</a>
				<div class="product-hover">
										<h2 class="product-name"><a href="#" title="Spor ayakkabı">Spor ayakkabı</a></h2><br/>
    ...
    <div class="price-box">
		    ...
		    <p class="old-price">
                ...
                <span class="price" id="old-price-11">
                    ...
                    <ul class="configurable-swatch-list configurable-swatch-sneakers_color clearfix">
                <li class="option-black is-media" data-product-id="11" data-option-label="black">
        <a href="javascript:void(0)" name="black" class="swatch-link swatch-link-134 has-image" title="black"
               style="height: 32px; width: 32px;">
            <span class="swatch-label" style="height: 30px; width: 30px; line-height: 30px;">
                            <img src="https://athlete.olegnax.com/media/catalog/swatches/10/30x30/media/black.png" alt="black" width="30" height="30" />
                         </span>
        </a>
    </li>
                <li class="option-blue is-media" data-product-id="11" data-option-label="blue">
        <a href="javascript:void(0)" name="blue" class="swatch-link swatch-link-134 has-image" title="blue"
               style="height: 32px; width: 32px;">
            <span class="swatch-label" style="height: 30px; width: 30px; line-height: 30px;">
                            <img src="https://athlete.olegnax.com/media/catalog/swatches/10/30x30/media/blue.png" alt="blue" width="30" height="30" />
                         </span>
        </a>
    </li>
                <li class="option-red is-media" data-product-id="11" data-option-label="red">
        <a href="javascript:void(0)" name="red" class="swatch-link swatch-link-134 has-image" title="red"
               style="height: 32px; width: 32px;">
            <span class="swatch-label" style="height: 30px; width: 30px; line-height: 30px;">
                            <img src="https://athlete.olegnax.com/media/catalog/swatches/10/30x30/media/red.png" alt="red" width="30" height="30" />
                         </span>
        </a>
    </li>
    </ul>
			...
			<div class="item-wrap">
				<a href="#" title="Spor ayakkabı " class="product-image">
															<img class="regular_img" id="product-original-image-24" src="../4mynot4give/assets/images/product/product-demo.jpg"  width="217" height="217" alt="Spor ayakkabı " />				</a>
				<div class="product-hover">
										<h2 class="product-name"><a href="#" title="Spor ayakkabı ">Spor ayakkabı </a></h2><br/>
    ...
    <div class="price-box">
			...
			<div class="item-wrap">
				<a href="#" title="Spor ayakkabı" class="product-image">
										<img id="product-collection-image-7"  class="additional_img" src="../4mynot4give/assets/images/product/product-demo.jpg"  width="217" height="217" alt="Spor ayakkabı" />					<img class="regular_img" id="product-original-image-7" src="../4mynot4give/assets/images/product/product-demo-1.jpg"  width="217" height="217" alt="Spor ayakkabı" />				</a>
				<div class="product-hover">
										<h2 class="product-name"><a href="#" title="Spor ayakkabı">Spor ayakkabı</a></h2><br/>
...
<script type="text/javascript">
    $j(document).on('product-media-loaded', function(event, galleryType) {
        ...
        ConfigurableMediaImages.init('small_image', swapHandler);
                ConfigurableMediaImages.setImageFallback(107, $j.parseJSON('{"option_labels":{"yellow-purple":{"configurable_product":{"small_image":null,"base_image":null},"products":["104"]},"purple-blue":{"configurable_product":{"small_image":null,"base_image":null},"products":["105"]},"green-yellow":{"configurable_product":{"small_image":null,"base_image":null},"products":["106"]},"blue-green":{"configurable_product":{"small_image":null,"base_image":null},"products":["103"]}},"small_image":{"104":"../4mynot4give/assets/images/product/product-demo.jpg","105":"../4mynot4give/assets/images/logo.png","106":"https:\/\/athlete.olegnax.com\/media\/catalog\/product\/cache\/10\/image\/473x473\/9df78eab33525d08d6e5fb8d27136e95\/b\/o\/boot1-3_1_1.jpg","103":"https:\/\/athlete.olegnax.com\/media\/catalog\/product\/cache\/10\/image\/473x473\/9df78eab33525d08d6e5fb8d27136e95\/s\/p\/sport-boots-s_1.jpg","107":"https:\/\/athlete.olegnax.com\/media\/catalog\/product\/cache\/10\/image\/473x473\/9df78eab33525d08d6e5fb8d27136e95\/s\/p\/sport-boots-s_1_2.jpg"},"base_image":[]}'));
