...
<script>//gonder olan kısıma bizim kayıt butonumuzun id'si yazılacak
							...
							url:"fast-shopping-cart-add.php?a="+product_id // Verilerin postlanağı adresi belirliyoruz.
							});}
						...
						<div class="card card--clean">
							<header class="card__header card__header--shop-filter">
								...
								<div class="shop-filter">
									<h5 class="shop-filter__result">Arama Sonucunuza Göre <?php echo $productCount; ?> Ürün Listelenmiştir</h5>
