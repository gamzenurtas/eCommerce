...
<body class="nuewin">
	...
	<div class="site-wrapper clearfix">
		...
		<div class="detail">
							<header style="margin-bottom:10px;" class="product__header">
							...
							<span style="margin-bottom:10px;" class="product__price"><?echo $product_price; ?> ₺</span>
							<span style="text-decoration: line-through; color:#dc3545;margin-left: 10px;" class="product__price"><?echo $product_price; ?> ₺</span>
    ...
    function showNotify(){
        Metro.notify.create("This is a notify", "Title", {});
						...
						<script>//gonder olan kısıma bizim kayıt butonumuzun id'si yazılacak
							...
							url:"shopping-cart-add.php?a=<?php echo $userid?>&b=<?php echo $id ?>&c=<?php echo $oid ?>&d=<?php echo $ooid ?>&e=<?php echo $rid ?>" // Verilerin postlanağı adresi belirliyoruz.
							});}
    ...
    $(document).ready(function () {
        $('#boyut').change(function () {
            ...
            $.ajax({
                url: "./fetch_boyut.php",
                method: "POST",
                data: { boyutAdi: boyut_adi, p_id : id,o_id:oid,oo_id:ooid},
                dataType: "text",
