...
<link rel="stylesheet" type="text/css" href="assets/css/options_base_gr.css" media="all" />
...
<script type="text/javascript" src="assets/js/jquery.anystretch.1.2.min.js"></script>
<script type="text/javascript" src="assets/js/jquery.noconflictt.js"></script>

<script type="text/javascript" src="assets/js/script.js"></script>
<script type="text/javascript" src="assets/js/product-media.js"></script>
<script type="text/javascript" src="assets/js/swatches-list.js"></script>
								...
								<div class="widget__content card__content">
									...
									<ul class="filter-color">
									 <?php
										...
										$query = "
										SELECT DISTINCT(ProductColorCode) FROM products WHERE isActive = '1' ORDER BY ProductColorCode DESC
										...
										<li class="filter-color__item">
											<label class="checkbox">
												<input type="checkbox" id="product_color_1" value="<?php echo $row['ProductColorCode']; ?>" class="common_selector color-violet ProductColorCode">
												<span style="background-color:<?php echo $row['ProductColorCode']; ?>; border-color:<?php echo $row['ProductColorCode']; ?>;" class="checkbox-indicator"></span>
											</label>
											<!--<div class="list-group-item checkbox">
												<label><input type="checkbox" class="common_selector ProductColorCode" value="<?php echo $row['ProductColorCode']; ?>" > <?php echo $row['ProductColorCode']; ?> GB</label>
											</div>-->
										</li>	
										<?php }?>										
									</ul>
						...
						<aside class="widget card widget--sidebar widget_filter-size">
							<form action="#" class="filter-size-form">
								...
								<div class="widget__content card__content">
									...
									<?php
										$query = "
										SELECT DISTINCT(optionValuesName) FROM optionvalues WHERE isActive = '1' ORDER BY optionValuesName DESC
										...
										<label class="checkbox checkbox--cell">
											...
											<span class="checkbox-indicator"><?php echo $row['optionValuesName']; ?></span>
										</label>
										<?php
										}?>
...
<script type="text/javascript">
    $j(document).on('product-media-loaded', function(event, galleryType) {
        ...
        ConfigurableMediaImages.init('small_image', swapHandler);
                ConfigurableMediaImages.setImageFallback(107, $j.parseJSON('{"option_labels":{"yellow-purple":{"configurable_product":{"small_image":null,"base_image":null},"products":["104"]},"purple-blue":{"configurable_product":{"small_image":null,"base_image":null},"products":["105"]},"green-yellow":{"configurable_product":{"small_image":null,"base_image":null},"products":["106"]},"blue-green":{"configurable_product":{"small_image":null,"base_image":null},"products":["103"]}},"small_image":{"104":"assets/images/product/product-demo.jpg","105":"assets/images/product/product-demo-1.jpg","106":"assets/images/product/1-1.PNG","103":"assets/images/product/1.PNG"},"base_image":[]}'));
...
$(document).ready(function(){
    ...
    function filter_data()
    {
        ...
        var ProductColorCode = get_filter('ProductColorCode');
        var optionValuesName = get_filter('optionValuesName');
        var ProductCode = get_filter('ProductCode');

        $.ajax({
            url:"fetch_data.php",
            method:"POST",
            data:{action:action, minimum_price:minimum_price, maximum_price:maximum_price, ProductColorCode:ProductColorCode, optionValuesName:optionValuesName, ProductCode:ProductCode},
