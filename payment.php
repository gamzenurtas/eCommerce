	...
	<div class="site-wrapper clearfix">
		...
		<div class="site-content">
			<div class="container">
				...
				<div style="margin-top: 185px;" class="board">
                    ...
                    <div class="tab-content">
						...
						<div class="alert alert-info text-dark">
							      <p style="text-align: center;">Bu sayfa PAYTR ödeme sayfasıdır PAYTR modülü sadece dafron.com alanı üzerinden çalıştığından dolayı sistem dafron.com adresine taşındıktan sonra aktif edilecektir....</p> 
						</div>
