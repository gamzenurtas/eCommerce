...
<head>
	...
	================================================== -->
	<!-- Vendor CSS -->
			<link href="assets/css/compressed_30353033323031393131.css" rel="stylesheet">
	...
	<link href="assets/css/libb.css" rel="stylesheet">
	<!-- Template CSS-->
...
<script src="assets/js/jquery.mask.js" rel="stylesheet"></script>
					...
					<div class="col-md-12">
						...
						<div class="card card--lg">
							...
							<div class="card__content">
								<form action="register_kontrol.php" method="post" class="df-personal-info">
